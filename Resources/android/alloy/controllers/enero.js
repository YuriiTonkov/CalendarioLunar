function Controller() {
    ...
    var exports = {};
    var __defers = {};
    $.__views.pantEnero = Ti.UI.createWindow({
        id: "pantEnero"
    });
    $.__views.pantEnero && $.addTopLevelView($.__views.pantEnero);
    $.__views.__alloyId3 = Ti.UI.createImageView({
        image: "/images/enero2014.png",
        top: "0px",
        height: "100%",
        left: "0px",
        width: "100%",
    ...
    $.__views.pantEnero.add($.__views.__alloyId3);
    ...
    $.__views.pantEnero.add($.__views.botAnterior);
    ...
    $.__views.pantEnero.add($.__views.botSiguiente);
    ...
    $.__views.pantEnero.add($.__views.botCerrarMes);
